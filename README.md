...
Input files come from the Amazon "Big Data" NOAA server, and obs are genrally provided by Synoptic Labs (www.synopticdata.com).

Note that the API from Synoptic Labs is designed to pull public-facing data only.  There are private mesonet networks out there that I can't put into this repo.
